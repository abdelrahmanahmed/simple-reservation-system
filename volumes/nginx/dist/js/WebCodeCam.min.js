...
(function(m,t,I,J){function C(a,e){this.element=a;d=m(a);this.options=m.extend({},D,e);this._defaults=D;this._name="WebCodeCam";this.init()&&(this.setEventListeners(),(this.options.ReadQRCode||this.options.ReadBarecode)&&this.setCallback())}var f=m('<video style="position:absolute;visibility:hidden;display: none;">')[0],n,r=!1,E=!1,k,d,g,h,F=new Worker("/js/DecoderWorker.js"),l=!1,D={ReadQRCode:!0,ReadBarecode:!0,width:320,height:240,videoSource:{id:!0,maxWidth:640,maxHeight:480},flipVertical:!1,flipHorizontal:!1,
